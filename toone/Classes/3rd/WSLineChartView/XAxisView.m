...
@property (strong, nonatomic) NSArray *xValueArray;
...
- (id)initWithFrame:(CGRect)frame xTitleArray:(NSArray*)xTitleArray xValueArray:(NSArray *)xValueArray yValueArray:(NSArray*)yValueArray yMax:(CGFloat)yMax yMin:(CGFloat)yMin {
    ...
    if (self.yValueArray && self.yValueArray.count > 0) {
        ...
        for (NSInteger i = 0; i < self.yValueArray.count; i++) {
            ...
            if (i == self.yValueArray.count-1) {
                ...
                CGPoint endPoint = CGPointMake(xValue*self.pointGap, chartHeight -  (endValue.floatValue-self.yMin)/(self.yMax-self.yMin) * chartHeight+topMargin);
                ...
                CGPoint startPoint = CGPointMake(xValue*self.pointGap, chartHeight -  (startValue.floatValue-self.yMin)/(self.yMax-self.yMin) * chartHeight+topMargin);
                CGPoint endPoint = CGPointMake(nextXValue*self.pointGap, chartHeight -  (endValue.floatValue-self.yMin)/(self.yMax-self.yMin) * chartHeight+topMargin);
