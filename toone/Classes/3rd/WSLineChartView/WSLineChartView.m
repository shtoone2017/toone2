...
- (void)creatXAxisView {
    ...
    self.xAxisView = [[XAxisView alloc] initWithFrame:CGRectMake(0, 0, self.xTitleArray.count * self.pointGap + lastSpace, self.frame.size.height) xTitleArray:self.xTitleArray xValueArray:self.xValueArray yValueArray:self.yValueArray yMax:self.yMax yMin:self.yMin];
