...
-(void)ui{
    ...
    _picker = [[UIDatePicker alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_cancel.frame), SCREEN_WIDTH , self.frame.size.height-button_height)];
    _picker.locale = [[NSLocale alloc]initWithLocaleIdentifier:@"zh_CN"];
    _picker.backgroundColor = [UIColor whiteColor];
    _picker.datePickerMode = UIDatePickerModeDate;
    _picker.minuteInterval = 1;//设置分钟间隔，默认一分钟
