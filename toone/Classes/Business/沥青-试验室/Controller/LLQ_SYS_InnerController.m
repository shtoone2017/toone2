...
- (void)viewDidLoad {
    ...
    self.index =1;
    self.vc = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"LLQ_YD_Controller"];
    if ([self.vc isKindOfClass:[LLQ_YD_Controller class]]) {
        LLQ_YD_Controller * controller = (LLQ_YD_Controller *)self.vc;
