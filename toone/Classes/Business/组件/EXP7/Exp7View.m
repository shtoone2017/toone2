...
@interface Exp7View()
@property (nonatomic,strong) Exp7_Xib_View * xib;
@property (nonatomic,assign) int buttonTag;
@end

@implementation Exp7View
...
-(instancetype)init{
    ...
    if (self) {
        ...
        Exp7_Xib_View * xib = [[NSBundle mainBundle] loadNibNamed:@"Exp7_Xib_View" owner:nil options:nil][0];
