...
@interface Exp5View()
@property (nonatomic,strong) Exp5_Xib_View * xib;
@end

@implementation Exp5View
...
-(instancetype)init{
    ...
    if (self) {
        ...
        Exp5_Xib_View * xib = [[NSBundle mainBundle] loadNibNamed:@"Exp5_Xib_View" owner:nil options:nil][0];
