...
@interface LQ_UsePosition_Controller ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic,strong) NSArray * datas;

@end

@implementation LQ_UsePosition_Controller
...
-(NSArray *)datas{
    if (!_datas) {
        ...
        NSString * urlString = url_usePosition;
