...
@interface Car_YSD_Model : MyModel
@property (nonatomic, copy) NSString *FCDBH;//发车单编号
@property (nonatomic, copy) NSString *JZLBH;
...
@property (nonatomic, copy) NSString *FCSJ;//发车时间
@property (nonatomic, copy) NSString *FCR;//发车人
@property (nonatomic, copy) NSString *XLWZ;
@property (nonatomic, copy) NSString *SCRQ;
@property (nonatomic, copy) NSString *BHZBH;//拌合站编号
@property (nonatomic, copy) NSString *BHZMC;
@property (nonatomic, copy) NSString *QDDJ;//强度等级
...
@property (nonatomic, copy) NSString *QSZP;
@property (nonatomic, copy) NSString *JSYY;
@property (nonatomic, copy) NSString *JSPZ;
@property (nonatomic, copy) NSString *CZR;
...
@property (nonatomic, copy) NSString *XLWZZB;
