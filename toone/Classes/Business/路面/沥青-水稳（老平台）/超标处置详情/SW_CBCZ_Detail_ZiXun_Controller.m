...
- (IBAction)commitClick:(UIButton *)sender{
    ...
    NSString * urlString = appHntChaobiaoZXDWShenpi;
    NSDictionary * dic = @{@"jieguobianhao":self.jieguobianhao,
                           ...
                           @"zxdw":[UserDefaultsSetting shareSetting].userFullName,
                           };
