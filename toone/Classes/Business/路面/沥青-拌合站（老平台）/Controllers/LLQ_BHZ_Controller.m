...
@implementation LLQ_BHZ_Controller
...
//    }
    ...
    NSString *urlString = [NSString stringWithFormat:lqWarningStat,_departId,startTimeStamp,endTimeStamp,_shebeibianhao,_fzlx,_hhllx];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self performSegueWithIdentifier:@"LLQ_BHZ_InnerController" sender:dict];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([vc isKindOfClass:[LLQ_BHZ_InnerController class]]) {
        LLQ_BHZ_InnerController * controller = vc;
