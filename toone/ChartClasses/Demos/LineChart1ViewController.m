...
@property (nonatomic,assign) int y_Min;
@property (nonatomic,assign) int y_Max;
@end
...
-(instancetype)initWithDict:(NSDictionary*)dict{
    ...
    if (self) {
        ...
        self.y_Min = [dict[@"y_Min"] intValue];
        self.y_Max = [dict[@"y_Max"] intValue];
        
        _chartView.leftAxis.axisMaximum = self.y_Max;
        _chartView.leftAxis.axisMinimum = self.y_Min;
    }
    return self;
}
@end
